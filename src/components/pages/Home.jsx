...
import {Box1, Box2, Box3, HomeContainer, MainContent, LogoLabefy, Banner_principal } from "./HomeStyled"
    ...
    return (
        <HomeContainer>
            ...
            <MainContent>
                ...
                <Box2>
                    <p>
                        Descubra novas músicas com sugestões baseadas no que você já gosta de escutar. Desfrute de bandas favoritas e artistas desconhecidos.
                    </p>
